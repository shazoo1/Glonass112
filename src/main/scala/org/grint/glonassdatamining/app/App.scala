...
object App {
    ...
    def main(args: Array[String]): Unit = {
        ...
        println("***Started to cluster data***")
        cluster(true)
...
//            .save("input")
    ...
    def cluster(saveNeeded: Boolean = true): RDD[OutputCsv] = {
        ...
        println(s"Joint addressesWithGps ${dataHelper.addressesWithGps.count()} and " +
          s"cards ${dataHelper.cards.count()} tables into a result table having ${dbTable.count()} rows")
